...
@Then("Address book should have zero entry (parameters)")
def step(context):
    snooze(1) #make sure everything is removed (animation)
    test.compare(waitForObjectExists(names.addressBookView_Item).children.count(), 1)